...
Workshop này hướng dẫn triển khai một hệ thống Web Application trên AWS, đảm bảo khả năng mở rộng, tính sẵn sàng cao và bảo mật.
...
- Amazon RDS SQL Server Multi-AZ lưu trữ dữ liệu với mô hình Primary - Standby.
