...
| Sun |Day Off | 07/06/2026 | 07/06/2026 | |
| Mon | - **Practice:** Exam Feature (Part 1).<br>&emsp;+ Analyze the logic and retrieve data for questions the user frequently answers incorrectly from their test history.<br>&emsp;+ Build the complete API to automatically generate review exams based on the user's incorrect/failed questions. | 08/06/2026 | 08/06/2026 | |
