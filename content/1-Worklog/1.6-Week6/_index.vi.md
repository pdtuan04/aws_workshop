...
| 4 | - **Thực hành:** Tính năng Comment.<br>&emsp;+ Phân tích thiết kế bảng dữ liệu cho tính năng comment phân cấp.<br>&emsp;+ Xây dựng các API cơ bản (thêm, sửa, xóa comment). | 27/05/2026 | 27/05/2026 | Nội bộ |
| 5 | - **Thực hành:** Tính năng Comment & Kiểm thử.<br>&emsp;+ Hoàn thiện luồng truy vấn để lấy danh sách comment phân cấp.<br>&emsp;+ Kiểm thử lại toàn bộ luồng đồng bộ dữ liệu qua RabbitMQ và các tính năng mới xây dựng. | 28/05/2026 | 28/05/2026 | Nội bộ |
