...
| Sun | - **Practice:** Email Function.<br>&emsp;+ Learn about libraries that support sending emails in the backend application.<br>&emsp;+ Build an email sending API (welcome email, notification email). | 17/05/2026 | 17/05/2026 | |
| Mon | - **Practice:** Flashcard Function.<br>&emsp;+ Design the table structure and data relationships for the flashcard feature.<br>&emsp;+ Build basic APIs (CRUD) to manage flashcards. | 18/05/2026 | 18/05/2026 | |
