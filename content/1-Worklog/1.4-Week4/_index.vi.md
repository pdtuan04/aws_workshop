...
| CN | - Nghiên cứu lý thuyết về các luồng cấp quyền (Grant Types) trong chuẩn OAuth2.<br> - **Thực hành:** Xác thực và Bảo mật.<br>&emsp;+ Xây dựng API xác thực người dùng.<br>&emsp;+ Tích hợp chuẩn OAuth2 vào hệ thống để quản lý quyền truy cập. | 10/05/2026 | 10/05/2026 | <https://learn.microsoft.com/vi-vn/aspnet/core/security/authentication/social/google-logins?view=aspnetcore-9.0> |
| 2 | - Tìm hiểu về kiến trúc CQRS (Command Query Responsibility Segregation) và phân tách luồng Đọc/Ghi.<br> - **Thực hành:** Xây dựng API (Phần 1).<br>&emsp;+ Áp dụng CQRS Pattern để thiết kế luồng xử lý.<br>&emsp;+ Xây dựng API cho chức năng làm bài kiểm tra và luyện tập. | 11/05/2026 | 11/05/2026 | <https://learn.microsoft.com/en-us/azure/architecture/patterns/cqrs> <br> <https://200lab.io/blog/cqrs-la-gi>|
