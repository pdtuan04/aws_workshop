...
* Research the theory of AWS WAF and its integration mechanism with Amazon CloudFront.
* Practice configuring Web ACLs on AWS WAF to optimize system security.
* Conduct comprehensive retesting and thoroughly fix arising bugs across all deployed features.
* Research documentation and complete 03 blog posts.
...
* Grasped the fundamental concepts of AWS WAF and the security integration workflow between WAF and Amazon CloudFront.
* Successfully deployed AWS WAF for CloudFront, establishing a simple initial security shield to protect the system against malicious traffic.
* Dedicated 02 full days to testing and resolving arising bugs.
* Researched documents and successfully completed 03 technical blog posts on schedule: "Optimizing Network Architecture with Amazon VPC Regional NAT Gateway", "Adding HTTP Security Headers with Amazon CloudFront", and "Benefits of Combining Amazon CloudFront with Application Load Balancer".