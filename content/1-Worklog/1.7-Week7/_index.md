...
| Sun | - **Practice:** Frontend Development.<br>&emsp;+ Build the User Interface (UI) to display the exam history section for users. | 31/05/2026 | 31/05/2026 | |
| Mon | - **Practice:** ALB & Auto Scaling Deployment (Part 1).<br>&emsp;+ Configure the Application Load Balancer to connect with the Auto Scaling Group.<br>&emsp;+ Deploy Manual Scaling (add servers manually) and Scheduled Scaling (set a schedule to automatically add servers). | 01/06/2026 | 01/06/2026 | <https://docs.aws.amazon.com/autoscaling/ec2/userguide/what-is-amazon-ec2-auto-scaling.html> <br> <https://000006.awsstudygroup.com/>|
